...
| Feature | Free | Team |
|---------|------|------|
| **URL Run** (test a live URL) | Yes | Yes |
| **PR Run** (validate code changes from a branch/PR) | — | Yes |
| **Sandbox Run** (autonomous agent exploration) | — | Yes |
| **Security scans** | — | Yes |
...
- Access to URL Run workflow only
...
- PR Run and Sandbox Run workflows
