...
When no run is active, you see a workflow selector with three options:

| Workflow | What it does | Plan |
|----------|-------------|------|
| **URL Run** | Test a live URL with an AI-planned test suite and optional digital twins. | Free |
| **PR Run** | Validate code changes from a branch or PR. Can be triggered manually or automatically via CI on every push. | Team |
| **Sandbox Run** | Deploy an autonomous agent to explore your app, combining redteam scanning with service twins. | Team |
...
- **Repository and branch** (optional, for PR Run workflow)
