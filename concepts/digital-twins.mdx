...
A digital twin is a stateful, behavioural clone of any external tool — Stripe, Slack, Discord, Google Drive, Box, or any third-party API — that replicates the endpoints, edge cases, and observable behaviours of the real service.
...
| `unified` | Unified API (`api.unified.to`) | Exposed as a sandbox surface in the UI. Use this when your app talks to Unified rather than directly to the upstream service. The current seeded providers in this twin are Slack, Google Mail, Google Drive, Box, Notion, and Dropbox. |
