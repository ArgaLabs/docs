...
| `google_calendar` | Google Calendar API (`www.googleapis.com`, `calendar.googleapis.com`) | Exposed as a sandbox surface in the UI. Intercepts Google Calendar v3 operations including calendars, events, free/busy queries, and webhook deliveries. |
