...
<Steps>
  ...
  <Step title="Run a staging validation">
    Open [app.argalabs.com/validate](https://app.argalabs.com/validate) and select **URL Run**:
    ...
    See [Validate modes](/features/validate-modes) for all three workflows.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Validate modes" icon="list-check" href="/features/validate-modes">
    Learn when to use URL Run, PR Run, and Sandbox Run.
  </Card>
