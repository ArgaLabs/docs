...
<Steps>
  ...
  <Step title="Run your first validation">
    ...
    <Info>
      **Free plan:** The `--prompt` flag is required on every run. On the Team plan, you can omit it and Arga will auto-plan tests based on your app. See [Plans and limits](/plans) for details.
    </Info>
  </Step>
...
<Steps>
  <Step title="Provision twins for your project">
    ...
    `arga wizard` automatically passes your saved API key from `arga login`. If you haven't logged in or prefer not to, use `npx arga-wizard` directly.
...
<CardGroup cols={2}>
  <Card title="Connect integrations" icon="plug" href="/integrations">
    Connect GitHub, Slack, Jira, Sentry, Notion, and other context sources for richer test plans.
  </Card>

  <Card title="Talk to our team" icon="calendar" href="https://cal.com/akiratong/30min?overlayCalendar=true">
    On a Team or Enterprise plan? Schedule a guided onboarding session.
  </Card>
</CardGroup>
