...
4. Select the twins you want in the sandbox. Arga currently supports `box`, `discord`, `dropbox`, `google_calendar`, `google_drive`, `notion`, `slack`, `stripe`, `unified`, and `unstructured`.
