...
2. Arga searches your connected sources (GitHub, Slack, Sentry, Jira, Linear, Grafana, PostHog)
...
<Note>Slack bot setup is handled during onboarding. Contact the Arga team to enable it for your workspace.</Note>
...
<Note>Discord bot setup is handled during onboarding. Contact the Arga team to enable it for your server.</Note>
