...
description: "Validate agent behaviour in safe, sandboxed environments (this feature is in private beta, we're looking for teams to iterate with)"
---
...
<Card title="Try it now" icon="rocket" href="/agent-testing-quickstart" horizontal>
  Get started with agent testing — run your first scan in under five minutes.
</Card>
