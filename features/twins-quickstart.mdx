...
<AccordionGroup>
  ...
  <Accordion title="GitHub" icon="github">
    ...
    **Quickstart state:**
    ...
    - Repository: `test-org/demo-repo` (public, Python, default branch: `main`)
    - Token: `ghp_test-github-twin-token`

    **Supported resources:** Repositories, pull requests, issues, branches, commits, check runs, file contents, search, organizations, users, webhooks, and OAuth flows.
  </Accordion>
