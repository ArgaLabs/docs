...
| `status` | `string` | Current status: `queued`, `generating_story`, `awaiting_approval`, `planning`, `waiting_for_deploy`, `provisioning`, `ready`, `running`, `completed`, `failed`, or `cancelled`. |
