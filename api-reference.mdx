...
| `runner_mode` | `string` | No | Runner to use: `visual` or `dom`. When omitted, the server selects the runner based on the default runtime profile. The web app always uses the `visual` runner. |
